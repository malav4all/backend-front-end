    ...
    },
    {
      ...
      subMenu: [
        ...
        },
        {
          ...
          activeIcon: geoZoneSvg(pinkDarkColor),
          text: "Industry",
          link: "/settings?tabValue=Industry",
        ...
        },
        {
          ...
          activeIcon: geoZoneSvg(pinkDarkColor),
          text: "Account",
          link: "/settings?tabValue=Account",
        ...
        },
        {
          ...
          activeIcon: geoZoneSvg(pinkDarkColor),
          text: "Location Type",
          link: "/settings?tabValue=LocationType",
          pageName: strings.LOCATIONTYPE,
        },
      ],
    },
    {
