...
const ListOfMenus = () =>
  [
    {
      icon: getDashboardIcon("#dbdbdb"),
      activeIcon: getDashboardIcon(pinkDarkColor),
      text: "Dashboard",
      link: "/dashboard",
      ...
      subMenu: [
        {
          ...
          pageName: strings.DISTANCE_REPORTS,
        },
        {
          icon: geoZoneSvg("#dbdbdb"),
          activeIcon: geoZoneSvg(pinkDarkColor),
          text: "Alert Reports",
          link: `${"/alert-reports"}`,
          pageName: strings.ALERT_REPORTS,
        },
        {
          icon: geoZoneSvg("#dbdbdb"),
          activeIcon: geoZoneSvg(pinkDarkColor),
    ...
    },
    {
      ...
      subMenu: [
        ...
        // },
        {
          ...
          pageName: strings.DEVICE_ONBOARDING,
        },
        {
          icon: getInventoryIcon("#dbdbdb"),
          activeIcon: getInventoryIcon(pinkDarkColor),
